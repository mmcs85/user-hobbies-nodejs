...
export function RegisterRoutes(app: express.Router) {
    ...
    // ###########################################################################################################
        app.get('/hobbies/:userId/:skip/:limit',
            ...(fetchMiddlewares<RequestHandler>(HobbiesController)),
            ...(fetchMiddlewares<RequestHandler>(HobbiesController.prototype.list)),

            function HobbiesController_list(request: any, response: any, next: any) {
            const args = {
        ...
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        app.get('/hobbies/:userId',
            ...(fetchMiddlewares<RequestHandler>(HobbiesController)),
            ...(fetchMiddlewares<RequestHandler>(HobbiesController.prototype.getById)),

            function HobbiesController_getById(request: any, response: any, next: any) {
            const args = {
                    userId: {"in":"path","name":"userId","required":true,"dataType":"string"},
            };
        ...
        app.post('/hobbies',
            ...(fetchMiddlewares<RequestHandler>(HobbiesController)),
            ...(fetchMiddlewares<RequestHandler>(HobbiesController.prototype.createUser)),

            function HobbiesController_createUser(request: any, response: any, next: any) {
            const args = {
        ...
        app.put('/hobbies',
            ...(fetchMiddlewares<RequestHandler>(HobbiesController)),
            ...(fetchMiddlewares<RequestHandler>(HobbiesController.prototype.updateUser)),

            function HobbiesController_updateUser(request: any, response: any, next: any) {
            const args = {
        ...
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        app.delete('/hobbies/:hobbyId',
            ...(fetchMiddlewares<RequestHandler>(HobbiesController)),
            ...(fetchMiddlewares<RequestHandler>(HobbiesController.prototype.deleteUser)),

            function HobbiesController_deleteUser(request: any, response: any, next: any) {
            const args = {
